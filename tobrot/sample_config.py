...
class Config(object):
    ...
    LEECH_COMMAND = os.environ.get("LEECH_COMMAND", "Ieech")
    YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "ytdI")
    RCLONE_CONFIG = os.environ.get("RCLONE_CONFIG", "")
    DESTINATION_FOLDER = os.environ.get("DESTINATION_FOLDER", "TorrentLeech-Gdrive")
    GLEECH_COMMAND = os.environ.get("GLEECH_COMMAND", "gIeech")
    INDEX_LINK = os.environ.get("INDEX_LINK", "")
    TELEGRAM_LEECH_COMMAND_G = os.environ.get("TELEGRAM_LEECH_COMMAND_G", "tIeech")
    ...
    PYTDL_COMMAND_G = os.environ.get("PYTDL_COMMAND_G", "pytdI")
